...
| **类别** | **名称**                    | **⚠️ 关键检查点 (必看!)**                                     | **实物图**                                                   |
| -------- | --------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 核心板   | C1-P02 开发板               | 确认开发板搭载的具体模组型号。                               | <img src="./media/开发板.jpg" alt="img" style="zoom:33%;" /> |
| 通信卡   | SIM 卡                      | 必须能发短信 (有些物联卡只能上网)                            | ![img](./media/OIP-C-1.webp)                                 |
| 配件     | LTE天线 (4GFPC天线YF0022AA) | 必须拧在标有 `LTE` 的接口上，拧反了或没拧紧可能出现没信号的情况。 | <img src="./media/天线.jpg" alt="img" style="zoom: 33%;" />  |
| 连接线   | USB 数据线(一端Type-C)      | 确保是数据线，不是只能充电的线。                             | <img src="./media/USB.webp" alt="img" style="zoom: 80%;" />  |
